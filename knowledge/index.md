...
* [002 Phase 4 lifecycle hardening - spec](specs/002-phase-4-lifecycle-hardening/spec.md) - End-to-end idempotent bootstrap, self-verifying zero-residue teardown, and staged spin-up measurement against the ten-minute target. Draft; not yet executed.
* [002 Phase 4 lifecycle hardening - plan](specs/002-phase-4-lifecycle-hardening/plan.md) - Implementation plan grounded in the `test-talos-spike` task chain, with the gate-3 adversarial review recorded. Draft.
* [002 Phase 4 lifecycle hardening - tasks](specs/002-phase-4-lifecycle-hardening/tasks.md) - Task list T001 to T014, with HUMAN markers on the owner-only decisions. Draft; requires a host with Docker and the full `mise` toolchain.
